...
/*
    ...
    private fun addExerciseData(){
        val a = ExerciseEntity(0, 0, "벤치프레스", 5, 2, 30, false)
        val b = ExerciseEntity(1, 1, "데드리프트", 10, 3, 40, false)
        val c = ExerciseEntity(2, 2, "스쿼드", 15, 4, 50, false)
        val d = ExerciseEntity(3, 3, "레그레이즈", 20, 5, 60, false)
        val e = ExerciseEntity(4, 4, "크런치(맛있다)", 25, 6, 70, false)
        val f = ExerciseEntity(5, 3, "이두컬", 30, 7, 30, false)
        val g = ExerciseEntity(6, 2, "아놀드프레스", 35, 8, 40, false)
        val h = ExerciseEntity(7, 1, "숄더프레스", 40, 7, 50, false)
        val i = ExerciseEntity(8, 2, "플랭크", 0, 6, 60, false)
        val j = ExerciseEntity(9, 3, "풀업", 0, 5, 70, false)
        val k = ExerciseEntity(10, 3, "팔굽혀펴기", 0, 4, 20, false)
        val l = ExerciseEntity(11, 4, "벤치프레스", 30, 6, 30, false)
