    ...
    fun initListener(){
        ...
        activity.fOption_iv_interval_plus.setOnClickListener {
            ...
            if(timeInSec>=MAX_TIME){
                activity.fOption_tv_interval_time.text = activity.getString(R.string.unit_time_min_sec,MAX_TIME/60,MAX_TIME%60)
                setting.restTime = MAX_TIME
            }else{
                activity.fOption_tv_interval_time.text = activity.getString(R.string.unit_time_min_sec,timeInSec/60,timeInSec%60)
        ...
        activity.fOption_iv_interval_minus.setOnClickListener {
            ...
            timeInSec -= 5
            if(timeInSec <=0){
                activity.fOption_tv_interval_time.text = activity.getString(R.string.unit_time_min_sec,0,0)
                setting.restTime = 0
            }else {
