...
class GetPlayViewIsClicked
@Inject constructor(private val homeRepository: HomeRepository) : UseCase<Boolean, UseCase.None>(){
    override suspend fun run(paramas: None) = homeRepository.getPlayViewClick()
}